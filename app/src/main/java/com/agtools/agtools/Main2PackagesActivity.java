...
public class Main2PackagesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main2_packages);
                        ...
                        try{
                            ...
                            if(response.length()>0)
                            {
                                ...
                                for(int j=0;j<jsonArray.length();j++)
                                {
                                    ...
                                    heroList.add(hero);
                                    adapter = new ListView2Adapter(heroList, getApplicationContext());
                                    ...
                                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                       ...
                                       if(schoolName.equals("Trial Package"))
                                        {
                                           Toast.makeText(getApplicationContext(),"Your Trail is Already used",Toast.LENGTH_LONG).show();
                                        }
                                        else if(schoolName.equals("Present Package paid monthly"))
                                            {
                                                try {
                                                    ...
                                                    Log.d("",""+newJson);
                                                    Intent intent=new Intent(Main2PackagesActivity.this,PresentActivity.class);
                                                ...
                                                try {
                                                    ...
                                                    JSONArray newJson=jsonObject.getJSONArray("packageDetails");
                                                    Log.d("",""+newJson);
                                                    Intent intent=new Intent(Main2PackagesActivity.this,FullActivity.class);
                                                    intent.putExtra("jsonObject", newJson.toString());
                                                    intent.putExtra("PackageName",schoolName);
                                                    startActivity(intent);
                                                } catch (JSONException e) {
