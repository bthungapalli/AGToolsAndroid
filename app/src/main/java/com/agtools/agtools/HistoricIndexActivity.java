...
public class HistoricIndexActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mon110=findViewById(R.id.mon110);
        mon111=findViewById(R.id.mon111);
        mon112=findViewById(R.id.mon112);
        ...
        String url= ApiConstants.API.concat("historic/cpi/"+responce+"/"+commodity+"?className=fresh_fruits&subuserType=0");
    ...
    private void showCHart() {
        ...
        leftAxis.setAxisMaxValue(380.1f);
        leftAxis.setAxisMinValue(357.97f);
        ...
        alert.setTitle("Consumer Index Avg Price Current Year Chart :");
    ...
    private void showYearsCHart()
    {
        ...
        mChartFuel = (LineChart)alertLayout.findViewById(R.id.currentlinkschart);
        TextView textView=alertLayout.findViewById(R.id.th1);
   ...
   private void showHistoricalYearsCHart ()
   {
       ...
       YAxis leftAxis = mChartFuel.getAxisLeft();
       leftAxis.removeAllLimitLines(); // reset all limit lines to avoid overlapping lines
       leftAxis.setAxisMaxValue(375.9f);
       leftAxis.setAxisMinValue(340.97f);
       ...
       set32.setFillColor(ContextCompat.getColor(getApplicationContext(), R.color.bl));
       lineDataSets.add(set1);
       lineDataSets.add(set2);
       lineDataSets.add(set32);
       LineData data3 = new LineData(montharrays1, lineDataSets);
       ...
       AlertDialog.Builder alert = new AlertDialog.Builder(this);
       alert.setTitle("Consumer Index Avg Price Data Historical Chart :");
       // this is set the view from XML inside AlertDialog
       alert.setView(alertLayout);
       // disallow cancel of AlertDialog on click of back button and outside touch
       alert.setCancelable(false);
