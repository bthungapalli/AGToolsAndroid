...
public class LiveWeathAdapter2 extends BaseAdapter {
    Context context;
    List<PlacesModal> placesModalList;
    TextView textplaceName;
    public LiveWeathAdapter2(Context context, List<PlacesModal> placesModalList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // placesIntent.putExtra("placeName2",placesModal.getPlaceName());
                SPHelper.setValueToPrefs(context,SPHelper.MyPREFERENCES,KEY_LIVEWEATHERCITY2,placesModal.getPlaceName());
