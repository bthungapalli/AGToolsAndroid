        ...
        try {
            ...
            customAdapterPresent = new CustomAdapterPresent(modelList, getApplicationContext(), new BtnClickListener() {
                ...
                public void onBtnClick(View view) {
                    ...
                    {
                        Intent intent1=new Intent(FullActivity.this,UserTypeActivity.class);
                    ...
                    {
                        Intent intent1=new Intent(FullActivity.this,UserTypeTwoActivity.class);
                        String price=model.getPrice();
                        String commodityCount=model.getCommodityCount();
                        intent1.putExtra("price",price);
                        intent1.putExtra("commodityCount",commodityCount);
                    ...
                    {
                        Intent intent1=new Intent(FullActivity.this,UserTypeThreeActivity.class);
                        String price=model.getPrice();
                        String commodityCount=model.getCommodityCount();
                        intent1.putExtra("price",price);
                        intent1.putExtra("commodityCount",commodityCount);
                    ...
                    {
                        Intent intent1=new Intent(FullActivity.this,UserTypeFourActivity.class);
                        String price=model.getPrice();
                        String commodityCount=model.getCommodityCount();
                        intent1.putExtra("price",price);
                        intent1.putExtra("commodityCount",commodityCount);
                    ...
                    {
                        Intent intent1=new Intent(FullActivity.this,UserTypeFiveActivity.class);
                        String price=model.getPrice();
                        String commodityCount=model.getCommodityCount();
                        intent1.putExtra("price",price);
                        intent1.putExtra("commodityCount",commodityCount);
