...
public class FreshFruitsHistoricActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_historic_fruit_index);
        ...
        String url= ApiConstants.API.concat("historic/cpi/"+responce+"/"+commodity+"?className=fruits_vegetables&subuserType=0");
    ...
    private void showCHart() {
        ...
        leftAxis.setAxisMaxValue(354.5f);
        leftAxis.setAxisMinValue(340.5f);
    ...
    private void showYearsCHart()
    {
        ...
        YAxis leftAxis = mChartFuel.getAxisLeft();
        leftAxis.removeAllLimitLines(); // reset all limit lines to avoid overlapping lines
        leftAxis.setAxisMaxValue(360);
        leftAxis.setAxisMinValue(325);
    ...
    private void showHistoricalYearsCHart ()
    {
        ...
        YAxis leftAxis = mChartFuel.getAxisLeft();
        leftAxis.removeAllLimitLines(); // reset all limit lines to avoid overlapping lines
        leftAxis.setAxisMaxValue(358.9f);
        leftAxis.setAxisMinValue(320.97f);
        leftAxis.setGranularity(0.01f);
