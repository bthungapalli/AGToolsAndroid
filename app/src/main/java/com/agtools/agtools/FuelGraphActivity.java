...
public class FuelGraphActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.d("",""+userid);
        String url= ApiConstants.API.concat("historic/oilprices/"+userid+"/"+selctCommidtyName+"?type=gas&subuserType=0");
        Log.d("",""+url);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(FuelGraphActivity.this);
    ...
    private  void getCurrentLinks()
    {
        ...
        leftAxis.setAxisMaxValue(4.95f);
        leftAxis.setAxisMinValue(2.69f);
        ...
        alert.setTitle("Gasoline Prices Current Year (Dollars per gallon) :");
    ...
    private  void getCurrentYearLinks()
    {
        ...
        YAxis leftAxis = mChartFuel.getAxisLeft();
        leftAxis.removeAllLimitLines(); // reset all limit lines to avoid overlapping lines
        leftAxis.setAxisMaxValue(3.75f);
        leftAxis.setAxisMinValue(1.80f);
        leftAxis.setGranularity(0.001f);
        leftAxis.setTextColor(Color.WHITE);
        mChartFuel.getAxisRight().setEnabled(false);
        mChartFuel.getAxisRight().setTextColor(Color.WHITE);
