...
public class ShippingWebActivity extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shipping_web);
        ...
        String url= ApiConstants.API.concat("#/shippingPriceMobile/"+responce+"/ALL/CENTRAL%20FLORIDA/"+commofity+"/1/0");
